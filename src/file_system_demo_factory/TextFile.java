...
class TextFile extends FileSystemComponent {

	private int size;

	TextFile(String name, int size, String ownerId) {
		this.name = name;
		this.type = "Text";
		this.size = size;
	...
	public String display(String indent) {
		return indent + "[TEXT] " + name + " | Owner: " + ownerId + " | Created: " + createDate + " | Size: " + size
				+ " KB" + " | " + permissionString() + "\n";
	}
}
